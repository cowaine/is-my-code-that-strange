package com.cowaine.thirteenth;
...
public class Book {
    ...
    private static void pp274To277() {
        User personalUser = new User(1, "(주)", "gdhong@gmail.com", "123$", "서울특별시 중구 세종대로 110", "010-1234-5678",
                "안녕하세요~", null, 0, "Dark", LocalDate.now());
        UserManager userManager = new UserManager(personalUser);

        User corporateUser = new User(1, "시라소니", "tpkang@gmail.com", "567*", "부산 해운대구 우동 1408", "010-8765-4321",
                "반갑습니다.", null, 0, "White", "02-345-6789");
        CorporationManager corporationManager = new CorporationManager(personalUser);
        ...
        corporationManager = new CorporationManager(personalUser);
