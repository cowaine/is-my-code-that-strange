...
public class AttackService {
    ...
    //어떤 일을 하는지 이해하기 힘든 로직
    public void attackToPlayerV1(int p1, int p2, int d1, int d2) {
        int d = 0;
        d = p1 + p2;
        d = d - (d1 + d2) / 2;
        if (d < 0) {
    ...
    //의도를 알 수 있는 이름 붙이기
    public void attackToPlayerV2(int playerArmPower, int playerWeaponPower, int enemyBodyDefence, int enemyArmorDefence) {
        int damageAmount = 0;
    ...
    public void attackToPlayerV3(int playerArmPower, int playerWeaponPower, int enemyBodyDefence, int enemyArmorDefence) {
    ...
    //의미를 알기 쉽게 메서드로 만들기
    public void attackToPlayerV4(int playerArmPower, int playerWeaponPower, int enemyBodyDefence, int enemyArmorDefence) {
        ...
        estimateDamage(totalPlayerAttackPower, totalEnemyDefence);
    }
